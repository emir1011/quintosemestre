...
# Inicializar
pygame.init()
pygame.mixer.music.load("y2mate.com - F1 Mexico GP Mariachi Intro 2021  Hermanos Rodriguez.ogg")
...
# Carga imágenes
fondo = pygame.image.load("1--3.jpg").convert()
nave_arr = pygame.image.load("f1up.png").convert_alpha()
nave_abj = pygame.image.load("f1down.png").convert_alpha()
nave_izq = pygame.image.load("f1LI.png").convert_alpha()
nave_der = pygame.image.load("f1LD.png").convert_alpha()

aste_1a = pygame.image.load("banAma-2.png").convert_alpha()
aste_1b = pygame.image.load("banRo-2.png").convert_alpha()
aste_1c = pygame.image.load("banna-2.png").convert_alpha()
aste_1d = pygame.image.load("banve-2.png").convert_alpha()
...
aste_2a = pygame.image.load("ferr.png").convert_alpha()
aste_2b = pygame.image.load("rb.png").convert_alpha()
aste_2c = pygame.image.load("mcl.png").convert_alpha()
aste_2d = pygame.image.load("merc.png").convert_alpha()
...
while en_juego:
    ...
    while en_inicio:
        ...
        historia = [
            ...
            "                        La temporada 2024.",
            "                    regreso a los coches antiguos ",
            "                pero los equipos se quejaron",
            "    Intenta traspasarlos para conseguir aprobar tu idea.",
            "",
    ...
    while en_partida:
        ...
        while en_final:
            ...
            historia_perdido = [
                "    No has conseguido terminar tu mision",
                "  ¿Quieres reparar tu coche y volver a intentarlo?",
                "",
                "              Pulsa 's' para volverlo a intentar",
                "              Pulsa 'n' para salir del juego"]

            historia_ganado = [
                "  Excelente, acabas de destruir a los equipos enemigos.",
